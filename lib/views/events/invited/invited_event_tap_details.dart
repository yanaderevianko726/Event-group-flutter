...
class InvitedEventTapDetails extends StatefulWidget {
  const InvitedEventTapDetails({
    Key? key,
  }) : super(key: key);

  @override
  State<InvitedEventTapDetails> createState() => _InvitedEventTapDetails();
}

class _InvitedEventTapDetails extends State<InvitedEventTapDetails> {
  @override
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    ConstantWidget.getTextWidget(
                      '${eventController.inviteEventModel.location}',
                      textColor,
                      TextAlign.left,
                      FontWeight.w500,
                      17.sp,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    getCustomText(
                      '${eventController.inviteEventModel.setupTime}',
                      textColor,
                      1,
                      TextAlign.start,
                      FontWeight.w400,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              getCustomText(
                                '${eventController.inviteEventModel.startTime}',
                                textColor,
                                1,
                                TextAlign.start,
                                FontWeight.w400,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              getCustomText(
                                '${eventController.inviteEventModel.finishTime}',
                                textColor,
                                1,
                                TextAlign.start,
                                FontWeight.w400,
              ...
              Padding(
                ...
                child: Text(
                  '${eventController.inviteEventModel.description}',
