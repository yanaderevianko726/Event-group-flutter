...
class HostingEventTapDetails extends StatefulWidget {
  const HostingEventTapDetails({Key? key, }) : super(key: key);

  @override
  State<HostingEventTapDetails> createState() => _HostingEventTapDetailsState();
}

class _HostingEventTapDetailsState extends State<HostingEventTapDetails> {
  @override
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    ConstantWidget.getTextWidget(
                      '${eventController.eventModel.location}',
                      textColor,
                      TextAlign.left,
                      FontWeight.w500,
                      17.sp,
              ...
              Padding(
                ...
                child: Text(
                  '${eventController.eventModel.description}',
