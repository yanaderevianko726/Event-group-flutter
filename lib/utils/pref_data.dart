...
class PrefData {
  ...
  static String vendorDetail = "${Constants.packageName}_vendorDetail";
  ...
  static setVendorDetail(String s) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(vendorDetail, s);
  }

  static getVendorDetail() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString(vendorDetail) ?? '';
  }
}
